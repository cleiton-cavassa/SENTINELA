...
public class FormCorridaFinalizada extends Formulario<CorridaFinalizada> {
	...
	public FormCorridaFinalizada(boolean novoRegistro, CorridaSolicitada corrida){
		if(novoRegistro){
		...
		Button button_1 = new BotaoSalvar<CorridaFinalizada>(
				"salvar",this, novoRegistro,true, SENTINELA.getFrota().getChave(),
				new Acionador<CorridaFinalizada>(this) );
