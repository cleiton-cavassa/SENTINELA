 ...
 public class FormCorridaSolicitada extends Formulario<CorridaSolicitada> {
	...
	public FormCorridaSolicitada(boolean novoRegistro){
		...
		DockPanel dock1 = new DockPanel();
			dock1.add(dataHoraEmbarque, DockPanel.WEST);
			dock1.add(localEmbarque, DockPanel.EAST);
		flow.add(dock1);
		dock1.setWidth("100%");
		
		DockPanel dock2 = new DockPanel();
			dock2.add(observacao, DockPanel.WEST);
			dock2.add(localPrevisaoDesembarque, DockPanel.EAST);
		flow.add(dock2);
		dock2.setWidth("100%");
