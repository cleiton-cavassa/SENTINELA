function sentinela(){
  ...
  sentinela.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  sentinela.onInjectionDone = function(){
    scriptsDone = true;
