function cleiton_unisul_piweb_rpc_ClassesRPC(){
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      ...
      cleiton_unisul_piweb_rpc_ClassesRPC = null;
  ...
  cleiton_unisul_piweb_rpc_ClassesRPC.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  cleiton_unisul_piweb_rpc_ClassesRPC.onInjectionDone = function(){
    scriptsDone = true;
...
cleiton_unisul_piweb_rpc_ClassesRPC();
