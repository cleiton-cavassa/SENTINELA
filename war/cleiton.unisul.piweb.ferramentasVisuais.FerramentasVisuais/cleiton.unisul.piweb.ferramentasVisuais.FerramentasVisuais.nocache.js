function cleiton_unisul_piweb_ferramentasVisuais_FerramentasVisuais(){
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      ...
      cleiton_unisul_piweb_ferramentasVisuais_FerramentasVisuais = null;
  ...
  cleiton_unisul_piweb_ferramentasVisuais_FerramentasVisuais.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  cleiton_unisul_piweb_ferramentasVisuais_FerramentasVisuais.onInjectionDone = function(){
    scriptsDone = true;
